    ...
    function scrollHandler(e) {
      ...
      function getInType(i) {
        var rect = i.element.getBoundingClientRect(),
          ...
          fullyIn = rect.bottom >= viewportHeight && rect.top <= 0,
          percentInView = fullyIn ? 1 : topIn || bottomIn ? ((bottomIn ? elementBottom : viewportBottom) - (topIn ? elementTop : viewportTop)) / rect.height : 0,
